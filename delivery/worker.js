...
<title>رفع النسخة المدفوعة</title>
<style>
body{font-family:system-ui,sans-serif;background:#f6f3ed;margin:0;color:#222}
.wrap{max-width:650px;margin:35px auto;padding:18px}
.card{background:#fff;border-radius:20px;padding:24px;box-shadow:0 10px 35px #0001}
label{display:block;font-weight:700;margin:16px 0 7px}
input,button{width:100%;box-sizing:border-box;padding:14px;border-radius:10px;font:inherit}
input{border:1px solid #ccc}
button{margin-top:18px;border:0;background:#111;color:#fff;font-weight:800}
.status{margin-top:18px;padding:14px;border-radius:10px;background:#f3f3f3;line-height:1.8}
.ok{background:#edf9ef}.bad{background:#fff0f0}.small{color:#666;line-height:1.8}
</style>
</head>
<body>
<main class="wrap">
