...
(function(){
  ...
  function start(){
    ...
    function local(text){
      ...
      if(/تستحق|ليه اشتري|لماذا اشتري|شنو الفائده|فائدتها|ماذا استفيد|شنو بشتري/.test(q)){S.intent='interest';score(15);reply('إذا كان هدفك التعلم بالعربية، فأنت تحصل على مرجع منظم من 250 صفحة ومعه وكيل ذكي في النسخة الكاملة. لكنني لا أريد أن أقول لك إنها تستحق السعر دون أن تراها. أفتح لك المعاينة الآن؟',[{type:'open_preview'}]);return true;}
