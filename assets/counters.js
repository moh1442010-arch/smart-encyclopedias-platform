...
(function(){
  ...
  function init(){addSeoSignals();addCounters();trackCurrentVisit();loadCounterLibrary();observeOrderSuccess();loadGabsterOnCheckout();setTimeout(refresh,900);setInterval(refresh,60000);}
