...
(function(){
  ...
  function trackCurrentVisit(){fetch(API+encodeURIComponent(NS)+'/view/'+encodeURIComponent(location.pathname),{cache:'no-store'}).catch(function(){});}
