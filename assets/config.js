...
(function loadStoreCounters(){
  function load(){if(document.getElementById('storeCountersScript'))return;var s=document.createElement('script');s.id='storeCountersScript';s.src='assets/counters.js';s.defer=true;document.head.appendChild(s);}
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',load);else load();
})();
